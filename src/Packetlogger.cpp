...
void Packetlogger::Initialize(SafeQueue* safeQueue)
{
    ...
    TNTClient = Memory::FindPattern((char*)"\xA1\x00\x00\x00\x00\x8B\x00\xE8\x00\x00\x00\x00\xA1\x00\x00\x00\x00\x8B\x00\x33\xD2\x89\x10", (char*)"x????xxx????x????xxxxxx");
    if (TNTClient) TNTClient += 1;
    SendAddy = Memory::FindPattern((char*)"\x55\x8B\xEC\x6A\x00\x6A\x00\x53\x8B\xD8", (char*)"xxxxxxxxxx");
}

// HATA ÇÖZÜMÜ: Packetlogger:: ön eki eklendi
